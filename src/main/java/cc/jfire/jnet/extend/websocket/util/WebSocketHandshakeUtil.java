...
public class WebSocketHandshakeUtil
{
    ...
    public static boolean isWebSocketUpgrade(HttpRequestPartHead head)
    {
        ...
        return "websocket".equalsIgnoreCase(upgrade) && connection != null && connection.toLowerCase().contains("upgrade") && secWebSocketKey != null && !secWebSocketKey.isEmpty() && "13".equals(secWebSocketVersion);
    }
