...
abstract class BaseLinkedQueuePad0<E> extends AbstractQueue<E> implements org.jctools.queues.MessagePassingQueue<E>
{
...
abstract class BaseLinkedQueue<E> extends BaseLinkedQueuePad2<E>
{
     ...
     *
     * @see org.jctools.queues.MessagePassingQueue#isEmpty()
     */
    @Override
