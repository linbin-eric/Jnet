...
public final class MessagePassingQueueUtil
{
    ...
    public static <E> int fillBounded(org.jctools.queues.MessagePassingQueue<E> q, Supplier<E> s)
    {
        return fillInBatchesToLimit(q, s, PortableJvmInfo.RECOMENDED_OFFER_BATCH, q.capacity());
    }

    public static <E> int fillInBatchesToLimit(org.jctools.queues.MessagePassingQueue<E> q, Supplier<E> s, int batch, int limit)
    {
