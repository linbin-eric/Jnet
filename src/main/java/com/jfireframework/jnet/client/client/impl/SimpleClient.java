...
import com.jfireframework.jnet.common.channelcontext.SimpleChannelContext;

public class SimpleClient extends AbstractClient
{
    
    public SimpleClient(ExecutorService businessExecutorService, ChannelContextBuilder clientChannelContextBuilder, AsynchronousChannelGroup channelGroup, String serverIp, int port, AioListener aioListener)
    {
    ...
    {
        ChannelContext serverChannelContext = new SimpleChannelContext(//
