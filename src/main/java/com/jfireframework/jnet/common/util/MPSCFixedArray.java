...
abstract class Pad3<E> extends Core<E>
{
    ...
    Pad3(int capacity)
    {
        ...
        try
        {
            ...
            Class<E> ckass = ((TypeVariable) type).get;
            int length = mask + 1;
...
public class MPSCFixedArray<E> extends AccessInfo<E>
{
    
    public MPSCFixedArray(int capacity)
    {
        super(capacity);
    }
    ...
    {
        MPSCFixedArray<String> array = new MPSCFixedArray<>(100);
    }
}
