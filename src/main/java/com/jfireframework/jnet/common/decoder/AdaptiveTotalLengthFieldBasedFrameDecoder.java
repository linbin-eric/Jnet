 ...
 */
public class AdaptiveTotalLengthFieldBasedFrameDecoder extends BindDownAndUpStreamDataProcessor<IoBuffer>
{
    // 代表长度字段开始读取的位置
     ...
     * @param maxLength
     */
    public AdaptiveTotalLengthFieldBasedFrameDecoder(int lengthFieldOffset, int lengthFieldLength, int skipBytes, int maxLength, BufferAllocator allocator)
    {
