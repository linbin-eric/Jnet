...
public abstract class AbstractWriteCompletionHandler implements WriteCompletionHandler
{
	...
	protected final MPSCLinkedQueue<IoBuffer>	queue			= new MPSCLinkedQueue<>();
	...
	public AbstractWriteCompletionHandler(AsynchronousSocketChannel socketChannel, AioListener aioListener, BufferAllocator allocator)
	{
