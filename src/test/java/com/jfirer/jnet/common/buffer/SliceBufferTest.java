...
public class SliceBufferTest
{
    ...
    public static Collection<?> data()
    {
        return Arrays.asList(new Object[][]{ //
                {new PooledBufferAllocator(100, true, new Arena("direct", BufferType.UNSAFE))},//
                {new PooledBufferAllocator(100, false, new Arena("heap", BufferType.HEAP))},//
        });
    }
    ...
    public void test()
    {
        ...
        buffer.free();
        assertEquals(0, ((UnPooledBuffer) buffer).getRefCnt().get());
    }
