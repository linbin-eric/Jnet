...
@SuiteClasses({ ArenaTest.class, HugeAllocateTest.class, PooledBufferRWTest.class, SmallAllocateTest.class, TinyAllocateTest.class, UnPooledBufferRWTest.class
})
@RunWith(Suite.class)
